...
// const future = new Date(2037, 10, 13, 15, 13);

// const calcDaysPassed = (date1, date2) =>
//   Math.abs((date2 - date1) / (1000 * 60 * 60 * 24));

// const days1 = calcDaysPassed(new Date(2037, 8, 14), new Date(2037, 5, 23));

// setTimeout:
// const ingredients = ['olives', 'spinach'];

// const pizzaTimer = setTimeout(
//   (ing1, ing2) => console.log(`Here os your pizza with ${ing1} and ${ing2} 🍕`),
//   2000,
//   ...ingredients,
// );
